...
Clone the GitHub repository, install the dependencies and start first the backend server and then start the frontend application:
(This assumes that you already have the NodeJS and NPM (or Yarn) packages installed)

```
$ git clone https://github.com/eduatletico/theRush.git
```
...
```
### Test
You can test accessing **[http://localhost:3000/](http://localhost:3000/)**
